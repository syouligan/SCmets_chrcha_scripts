...
qsub -P OsteoporosisandTranslationalResearch -N 'Markers_TissuevsTissue_'$projectID -b y -hold_jid 'Prefiltering_'$projectID -wd $logDir -j y -R y -l mem_requested=8G -pe smp 32 -V -m bea -M s.youlten@garvan.org.au R CMD BATCH $scriptsPath$projectID'/'$projectID'_scripts/TissuevsTissue_marker_enrichment_analysis_Seurat.R'
qsub -P OsteoporosisandTranslationalResearch -N 'Markers_TissuevsAll_'$projectID -b y -hold_jid 'Prefiltering_'$projectID -wd $logDir -j y -R y -l mem_requested=8G -pe smp 32 -V -m bea -M s.youlten@garvan.org.au R CMD BATCH $scriptsPath$projectID'/'$projectID'_scripts/TissuevsAll_marker_enrichment_analysis_Seurat.R'
qsub -P OsteoporosisandTranslationalResearch -N 'SeuratCluster_'$projectID -b y -hold_jid 'Markers_TissuevsTissue_'$projectID -wd $logDir -j y -R y -l mem_requested=8G -pe smp 32 -V -m bea -M s.youlten@garvan.org.au R CMD BATCH $scriptsPath$projectID'/'$projectID'_scripts/Whole_experiment_seurat_merge_and_clustering.R'
