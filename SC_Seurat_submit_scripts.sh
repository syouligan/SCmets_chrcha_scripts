...
qsub -P OsteoporosisandTranslationalResearch -N 'PseudoDGE_GO_'$projectID -b y -hold_jid 'PseudoDGE_tissue_'$projectID -wd $logDir -j y -R y -l mem_requested=8G -pe smp 5 -V -m bea -M s.youlten@garvan.org.au R CMD BATCH $scriptsPath$projectID'/'$projectID'_scripts/Pseudo-bulk_GO_by_tissue.R'
qsub -P OsteoporosisandTranslationalResearch -N 'PseudoDGE_GO_venn_'$projectID -b y -hold_jid 'PseudoDGE_tissue_'$projectID -wd $logDir -j y -R y -l mem_requested=8G -pe smp 5 -V -m bea -M s.youlten@garvan.org.au R CMD BATCH $scriptsPath$projectID'/'$projectID'_scripts/Pseudo-bulk_GO_by_tissue_venn_partitioning.R'
qsub -P OsteoporosisandTranslationalResearch -N 'PseudoDGE_hallmark_heatmaps_'$projectID -b y -hold_jid 'SeuratCluster_'$projectID -wd $logDir -j y -R y -l mem_requested=8G -pe smp 5 -V -m bea -M s.youlten@garvan.org.au R CMD BATCH $scriptsPath$projectID'/'$projectID'_scripts/Pseudo-bulk_by_tissue_hallmark_heatmaps.R'
