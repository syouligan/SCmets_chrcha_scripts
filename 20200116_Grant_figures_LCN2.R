...
GOI.sce <- filtered_exp[is.element(rowData(filtered_exp)$GeneSymbol, c("ZEB1", "CD44", "LCN2")),]
...
# Impute counts for ZEB1, CD44, LCN2 genes with MAGIC
data_MAGIC <- magic(Matrix::t(assay(filtered_exp, "logcounts")), genes=c("ZEB1", "CD44", "LCN2"))
